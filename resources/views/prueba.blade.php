        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Listado de productos de prueba
                    <a href=" {{ url('home') }} ">
                      <span class="badge pull-right" data-toggle="tooltip" data-placement="top" title="Regresar"><i class="fa fa-arrow-left"></i></span>
                    </a>
                </div>
                <div class="panel-body">
                  <a class="pull-right" href="{{ url('formulario-producto-prueba') }}">Agregar Nuevo Producto de Prueba</a><hr />
                  @if(session('status'))
